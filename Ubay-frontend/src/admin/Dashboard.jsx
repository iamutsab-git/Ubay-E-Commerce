...
const Dashboard = () => {
  ...
  return (
    <div className="container bg-gray-900 min-h-[100vh] mx-auto p-4 md:p-6">
        ...
        <>
          {!activeSection ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Users Card */}
              <div
                className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-xl transition transform hover:-translate-y-1 cursor-pointer"
                onClick={() => setActiveSection("users")}
              >
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Users</h2>
                  <div className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                  </div>
                </div>
                <p className="text-3xl text-blue-600 dark:text-blue-400 my-2">{stats.users}</p>
                <p className="text-gray-600 dark:text-gray-300 mt-2">Recent Users:</p>
                {recentOrders.slice(0, 3).map((order) => (
                  <p key={order._id} className="text-sm text-gray-500 dark:text-gray-400 truncate">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                  </div>
                </div>
                <p className="text-3xl text-green-600 dark:text-green-400 my-2">{stats.products}</p>
                <p className="text-gray-600 dark:text-gray-300 mt-2">Popular Products:</p>
                {popularProducts.slice(0, 3).map((product) => (
                  <p key={product._id} className="text-sm text-gray-500 dark:text-gray-400 truncate">
                    {product.name}
                  </p>
                ))}
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Orders</h2>
                  <div className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-full p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                  </div>
                </div>
                <p className="text-3xl text-purple-600 dark:text-purple-400 my-2">{stats.orders}</p>
                <p className="text-gray-600 dark:text-gray-300 mt-2">Recent Orders:</p>
                {recentOrders.slice(0, 3).map((order) => (
                  <p key={order._id} className="text-sm text-gray-500 dark:text-gray-400 truncate">
