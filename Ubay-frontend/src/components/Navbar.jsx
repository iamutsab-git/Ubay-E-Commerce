...
const Navbar = () => {
  ...
  return (
    <div className='bg-white border border-orange-400 my-1 sticky top-0 z-10  max-w-8xl'>
      <nav className='flex justify-between items-center px-2 py-2 mx-6'>
        ...
        <div className='hidden md:block'>
          <ul className='list-none flex justify-between space-x-4 items-center'>
            <Link to="/"><li className='hover:text-orange-500 relative group'>Home<span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span></li></Link>
            <Link to="/about"><li className='hover:text-orange-500 relative group'>About<span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span></li></Link>
            <Link to="/collection"><li className='hover:text-orange-500 relative group'>Collection<span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span></li></Link>
            <Link to="/contact"><li className='hover:text-orange-500 relative group'>Contact<span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span></li></Link>

            {!currentUser ? (
              <>
                <Link to="/login"><li className='hover:text-orange-500 relative group'><FaRegUser /><span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span></li></Link>
              </>
            ) : (
              <>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className='md:hidden bg-white border-t border-orange-400 px-4 py-4 space-y-3'>
